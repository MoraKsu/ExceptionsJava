package seminar03.controllers;

import seminar03.exceptions.InvalidDataFormatException;
import seminar03.models.UserData;
...
public class AppController {
    ...
    public void start() {
        ...
        } catch (IllegalArgumentException | InvalidDataFormatException | IOException e) {
            view.displayError(e.getMessage());
        }
    }

    private void parseInputData(String input) throws InvalidDataFormatException {
